...
public class Historico {
	...
	public void insereHistorico(String nomeUsu, BigDecimal nuNota) {
		...
		try {
			...
			String obser = " Verificação de patrimonio AUDITORIA > CONTABILIDADE !";
			...
			try {
				...
				DynamicVO savePar = hisDAO.create()
						...
						.set("USUARIO", nomeUsu)
						.set("DATA", agora)
						.set("ACAO", "VERIFICAR > PATRIMONIO")
						.set("PROCESSO", "VERIFICAÇÃO PATRIMONIO CONTABILIDADE > AUDITORIA")
						.set("OBS", obs)
